...
- O script de criação do banco pode ser encontrado em [script de criação](conceptual-model/academiaCriacao.sql).
- O script de população do banco pode ser encontrado em [script de população](conceptual-model/academiaPopulacao.sql). 
